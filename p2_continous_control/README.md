...
- `Continuous_Control_DDPG.ipynb`: notebook containing the solution
- `ddpg_agent.py`: code for the agent used in the environment
- `model.py`: code containing the Actor and Critic Networks used as the function approximators by the agent
